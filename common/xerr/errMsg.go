...
func init() {
	...
	message[LoginAppleIDError] = "Apple ID 错误"
	message[UserNotFoundError] = "用户不存在"
	message[CaptchaError] = "验证码错误"
	message[PasswordError] = "密码错误"
	message[EmailFormatError] = "邮箱格式错误"
	message[EmailExistsError] = "邮箱已存在"
	message[RegisterError] = "注册失败"
	...
	message[LearningRecordDetailAlreadyExists] = "章节学习记录已存在"
